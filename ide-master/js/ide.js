...
function handleResult(data) {
    ...
    console.log("oppppp",data.stdout);
...
function run() {
    ...
    var sendRequest = function (data) {
        ...
        $.ajax({
            "async": true,
            "crossDomain": true,
            "url": "https://judge0-ce.p.rapidapi.com/submissions?base64_encoded=true&wait=${wait}&fileds=*",
            "method": "POST",
            "headers": {
                "content-type": "application/json",
                "Content-Type": "application/json",
                "X-RapidAPI-Key": "dc059a336amsh8e12cca7a7e576cp1dcb07jsn7c543bece58f",
        ...
        //     "async": true,
        //     "crossDomain": true,
        //     "url": "https://judge0-ce.p.rapidapi.com/submissions?base64_encoded=true&wait=${wait}",
        //     "method": "POST",
        //     "headers": {
        //         "content-type": "application/json",
        //         "Content-Type": "application/json",
